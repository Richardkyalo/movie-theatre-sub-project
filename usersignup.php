...
<body>
    ...
    <div class="container-sm shadow-lg border col-4 mt-5 mb-5">
        ...
        <form action="signupdb.php" method="post">
            ...
            <p>Have an account?<a href="userlogin.php">Click here</a> to Login</p>
            <button type="submit" name="signup-button" class="btn btn-primary btn-block active col-12">Sign Up</button>
        </form>
